...
const ErrorLoading = dynamic(() => import("../404"), { ssr: false });
const MdOutlineRemoveRedEye = dynamic(
  () => import("react-icons/md").then((mod) => ({ default: mod.MdOutlineRemoveRedEye })),
  { ssr: false }
);
...
const BlogJsonLd = dynamic(() => import("@/components/blog/BlogJsonLd"), { ssr: true });
const BlogFaq = dynamic(() => import("@/components/blog/BlogFaq"), { ssr: false });
const BlogCtaSection = dynamic(() => import("@/components/blog/BlogCtaSection"), { ssr: false });
const BlogContactModal = dynamic(() => import("@/components/blog/BlogContactModal"), { ssr: false });
  ...
  return blogData ? (
    <>
      ...
      <Head>
        ...
        <BlogJsonLd blogData={blogData} metadata={metadata} slug={slug} />
      </Head>
      <div className="inner-wrapper">
        ...
        <BlogContactModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} />
      </div>
    </>
  ) : null;
};
