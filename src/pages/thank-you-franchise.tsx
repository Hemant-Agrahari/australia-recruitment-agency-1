...
const ThankYouFranchise: React.FC<ThankYouProps> = () => {
    ...
    {"@type":"WebPage","@id":"https://www.alliancerecruitmentagency.ae/thank-you-franchise/#webpage",
     "url":"https://www.alliancerecruitmentagency.ae/thank-you-franchise/",
     "name":"Thank you Franchise -",
     "datePublished":"2020-12-31 11:43",
     "dateModified":"2021-07-08 11:27",
     "author":
    ...
    {"@id":"https://allianceae-10072.kxcdn.com/wp-content/uploads/2023/02/Alliance.ae_.png"}
    ,"inLanguage":"en-US"},{"@type":"Article","headline":"Thank you Franchise -","datePublished":"2020-12-31 11:43","dateModified":"2021-07-08 11:27","author":
    
    {"url":"https://www.alliancerecruitmentagency.ae/author/allianceadmin/","@type":"Person","name":"Pallavi Chawla"}
    ,"description":"","name":"Thank you Franchise -","@id":"https://www.alliancerecruitmentagency.ae/thank-you-franchise/#schema-5710","isPartOf":
    ...
    {"@id":"https://allianceae-10072.kxcdn.com/wp-content/uploads/2023/02/Alliance.ae_.png"}
    ,"inLanguage":"en-US","mainEntityOfPage":{"@id":"https://www.alliancerecruitmentagency.ae/thank-you-franchise/#webpage"}}]}`
    const script2 = `{
"@context": "https://schema.org",
"@type": "Organization",
"name": "Alliance Recruitment Agency",
  ...
  "itemListElement": [{
    ...
    return (
        <div>
            ...
            <CustomHead
                {...meta["thank-you-franchise"]}
            />
            <>
                {/* <!-- Recruitment section start--> */}
                <section className="accounting-section " style={{ padding: "80px !important", marginTop: "20px", marginBottom: "20px" }}>
                    <div className="container">
                        <div className="inner-con">
                            <div className="row gy-4">
                                <div className="col-lg-12 d-flex justify-content-center flex-column align-items-center">
                                    <Image style={{ maxWidth: "110px" }} width={10} height={10} src="assets/images/done-icon.svg" alt="Done" loading="lazy"
...
export default ThankYouFranchise;