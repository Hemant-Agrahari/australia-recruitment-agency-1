...
// Modal Contact Form Component (Inner)
const BlogContactFormChild: React.FC<ModalContactFormProps> = ({ onSuccess, apiEndpoint, type, id }) => {
    ...
    const handleHelpOptionChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
        console.log("handleHelpOptionChange", e.target.value);
                ...
                <div className="row g-3">
                    ...
                    <div className="col-md-6">
                        <div className="form-group" style={{ marginBottom: '16px' }}>
                            <PhoneInput
                                ...
                                containerClass="phone-input-container blog-contact-form-phone-input"
                            />
                    ...
                    <div className="col-md-6">
                        <div className="form-group" style={{ marginBottom: '16px' }}>
                            <select
                                name="helpOption"
                                className="form-control blog-contact-form-select-dropdown-value"
...
const BlogContactForm: React.FC<ModalContactFormProps> = (props) => {
    return (
        <GoogleCaptchaWrapper>
            <BlogContactFormChild {...props} />
        </GoogleCaptchaWrapper>
    );
};
