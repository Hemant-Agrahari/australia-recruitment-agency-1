            ...
            executeRecaptcha("enquiryFormSubmit").then(async (gReCaptchaToken: any) => {
                try {
                    const requestdata = {
                        ...
                        currentFormUrl: `https://www.alliancerecruitmentagency.ae${currentUrl}`
                    }
                    console.log("requestdata", requestdata)
                    const { statusText, status, data } = await axios.post('https://allianceaeapi.alliancerecruitmentagency.ae/handbook_enquiryForm', requestdata);
