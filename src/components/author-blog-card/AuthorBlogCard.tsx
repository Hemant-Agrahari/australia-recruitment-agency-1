        ...
        <div className={styles['blog-card']}>
            <div className={`${styles['blog-body']} p-4`}>
                <Link href={`/blog/${blog.slug}`} className={styles['title-link']}>
                    <h3 className={`${styles['blog-card-title']} mb-3`}>{blog.bannerTitle}</h3>
                </Link>

                <div className={`${styles['blog-meta-row']} mb-4`}>
                    <span className={styles['views-badge']}>
                        <svg className="me-1" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <span className={styles['meta-sep']}>|</span>
                    <span className={styles['meta-text']}>{blog.author?.bannerTitle}</span>
                </div>
                ...
                <div
                    ...
                    dangerouslySetInnerHTML={{ __html: blog.bannerDesp.replace(/<[^>]*>?/gm, '').substring(0, 180) + '...' }}
                />
